...
define void @"#dynarray::extend"(ptr nocapture %self, ptr nocapture readonly %add_buf, i64 %add_len) local_unnamed_addr #0 {
body:
...
; Function Attrs: mustprogress nounwind willreturn
define void @"#dynarray::resize"(ptr nocapture %self, i64 %new_cap) local_unnamed_addr #0 {
body:
...
; Function Attrs: mustprogress nounwind willreturn
define %string @"string::new"(ptr nocapture readonly %contents, i64 %len) local_unnamed_addr #0 {
body:
...
define void @"int::trailing_zeroes"(i64 %self) local_unnamed_addr #7 {
body:
  ret void
}
...
define void @"#dynarray::pop"(ptr nocapture %self) local_unnamed_addr #8 {
body:
  %path_access = getelementptr inbounds %"#dynarray", ptr %self, i64 0, i32 1
  %path_load = load i64, ptr %path_access, align 4
...
; Function Attrs: mustprogress nounwind willreturn
define %string @"string::add_string"(ptr nocapture readonly %self, ptr nocapture readonly %other) local_unnamed_addr #0 {
body:
...
define i64 @"string::len"(ptr nocapture readonly %self) local_unnamed_addr #9 {
body:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone willreturn
define void @"int::count_ones"(i64 %self) local_unnamed_addr #7 {
body:
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone willreturn
define void @"int::reverse_bytes"(i64 %self) local_unnamed_addr #7 {
body:
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone willreturn
define void @"int::reverse_bits"(i64 %self) local_unnamed_addr #7 {
body:
  ret void
}

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define %string @"string::to_string"(ptr nocapture readonly %self) local_unnamed_addr #9 {
body:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone willreturn
define i64 @"int::sign"(i64 %self) local_unnamed_addr #7 {
body:
...
define void @print(ptr nocapture readonly %s) local_unnamed_addr #10 {
body:
...
; Function Attrs: nofree nounwind
declare noundef i64 @printf(ptr nocapture noundef readonly, ...) local_unnamed_addr #10
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone willreturn
define void @"int::leading_zeroes"(i64 %self) local_unnamed_addr #7 {
body:
  ret void
}
...
; Function Attrs: mustprogress nounwind willreturn
define void @"#dynarray::push"(ptr nocapture %self, i8 %byte) local_unnamed_addr #0 {
body:
  %path_access = getelementptr inbounds %"#dynarray", ptr %self, i64 0, i32 1
  %path_load = load i64, ptr %path_access, align 4
...
attributes #9 = { argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn }
